...
class WorkflowService:
    ...
    async def execute_run(
        ...
        trace_events = self._build_trace_events(case, run_id, coverage)
        ...
        run.summary = (
            f"Generated {len(report_bundles)} report bundles with "
    ...
    def _build_trace_events(self, case, run_id: str, coverage) -> list[RunTraceEventRecord]:
        ...
        return [
            ...
            RunTraceEventRecord(
                ...
                message="Executive memo and issue register markdown bundles were rendered.",
                level=RunEventLevel.INFO.value,
            ),
        ]
