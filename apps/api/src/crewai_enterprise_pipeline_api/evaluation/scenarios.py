...
MATRIX_COVERAGE_SCENARIOS: tuple[EvaluationScenario, ...] = (
    ...
    EvaluationScenario(
        ...
        rich_reporting_expectation=RichReportingExpectation(
            report_template="lender",
            required_export_files=(
                "reports/full_report_lender.md",
                "reports/full_report_lender.docx",
                "reports/full_report_lender.pdf",
                "reports/financial_annex.md",
            ),
        ),
        run_payload={
            "requested_by": "Evaluation Runner",
            "note": "Automated run for lender report evaluation.",
            "report_template": "lender",
        },
        expectation=ScenarioExpectation(
            approval_decision="approved",
